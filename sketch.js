...
function setup() {
	...
	bob1 =Bodies.circle(300,350,30,bob_options);
	World.add(world,bob1);
	
	bob2 =Bodies.circle(250,350,30,bob_options);
	World.add(world,bob2);

	bob3 =Bodies.circle(200,350,30,bob_options);
	World.add(world,bob3);

	bob4 =Bodies.circle(350,350,30,bob_options);
	World.add(world,bob4);

	bob5 =Bodies.circle(400,350,30,bob_options);
...
function keyPressed(){
	if(keyCode===UP_ARROW){
		Matter.Body.applyForce(bob1,{x:0,y:0},{x:-50,y:-10})
	}
